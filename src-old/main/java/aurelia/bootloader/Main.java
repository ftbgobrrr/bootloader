package aurelia.bootloader;

import aurelia.bootloader.components.ProgressBar;
...
public class Main extends JFrame implements ILauncherHandler {
    ...
    public Main() {
        ...
        this.setTitle("Aurelia - Bootloader");
        ...
        label = new JLabel("Verification des mises à jour");
    ...
    public void verify() {
        try {
            ...
            if (!isNet) {
                ...
                JOptionPane.showMessageDialog(null, "Aucune connection internet", "Aurelia Bootloader Error", JOptionPane.ERROR_MESSAGE);
                System.exit(0);
                return;
            }
    ...
    public void launch() {
        try {
            ...
            arguments.add("aurelia.launcher.Launcher");
    ...
    public void startUpdate(LauncherFile file) {
        label.setText("Telechargement de la mise à jour");
    }
